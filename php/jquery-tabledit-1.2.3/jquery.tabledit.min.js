...
!function(t){
	...
	t.fn.Tabledit=function(e){
		function n(e){
			...
			a=d.onAjax(e,n);if(a===!1)return!1;
	...
	columns:{
		...
		editable:function(){
			...
			n.each(function(){
				...
				t(this).html(i+a),t(this).addClass("tabledit-view-mode")})}},toolbar:function(){if(d.editButton||d.deleteButton){
				var t="",e="",n="",a="",s="";
				0===i.find("th.tabledit-toolbar-column").length&&i.find("tr:first").append('<th class="tabledit-toolbar-column"><form method="post" action="C:/xampp/htdocs/views/action.php"></form></th>'),d.editButton&&(t='<button type="button" class="tabledit-edit-button '+d.buttons.edit["class"]+'" style="float: none;">'+d.buttons.edit.html+"</button>"),
				d.deleteButton&&(e='<button type="button" class="tabledit-delete-button '+d.buttons["delete"]["class"]+'" style="float: none;">'+d.buttons["delete"].html+"</button>",
